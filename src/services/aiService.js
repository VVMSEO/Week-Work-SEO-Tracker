...
Учти, что целевая нагрузка в неделю составляет 25-30 часов, а в день должно выходить около 5-6 часов (300-360 минут). 
Распредели проекты так, чтобы суммарная нагрузка в минутах была максимально равномерной каждый день и приближалась к этой норме. Не разбивай один проект на несколько дней, просто назначь каждому проекту один день.
